...
CorrCollaborative <-
  CorrCollaborative[(
    CorrCollaborative$group == 17 | CorrCollaborative$group == 18 |
      CorrCollaborative$group == 19 |
      CorrCollaborative$group == 20 |
      CorrCollaborative$group == 33 |
      CorrCollaborative$group == 35 |
      CorrCollaborative$group == 37 |
      CorrCollaborative$group == 39 |
      CorrCollaborative$group == 41 |
      CorrCollaborative$group == 44 |
      CorrCollaborative$group == 46 |
      CorrCollaborative$group == 47 |
      CorrCollaborative$group == 49
  ), ]

CorrIndividual <-
  CorrIndividual[(
    CorrIndividual$group == 17 | CorrIndividual$group == 18 |
      CorrIndividual$group == 19 |
      CorrIndividual$group == 20 |
      CorrIndividual$group == 33 |
      CorrIndividual$group == 35 |
      CorrIndividual$group == 37 |
      CorrIndividual$group == 39 |
      CorrIndividual$group == 41 |
      CorrIndividual$group == 44 |
      CorrIndividual$group == 46 |
      CorrIndividual$group == 47 |
