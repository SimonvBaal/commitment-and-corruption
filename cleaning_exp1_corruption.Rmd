...
```{r Loading data}
Q <- read.csv("Questionnaire.csv", stringsAsFactors = FALSE)

# These are the collaborative rounds
CorrCollaborative <- read.csv("Corruption_23.csv")
CorrCollaborative2 <- read.csv("September23.csv")

## Practice and individual rolls
CorrIndividual <- read.csv("Corruption_14.csv")
CorrIndividual2 <- read.csv("September14.csv")
